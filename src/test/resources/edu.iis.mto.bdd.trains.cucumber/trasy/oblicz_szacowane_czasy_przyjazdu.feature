...
Szablon scenariusza: Oszcuj czas przyjazdu.
	Zakładając chcę się dostać z "<start>" do "<stop>"
	I następny pociąg odjeżdża o <time> na linii "<line>"

	Gdy zapytam o godzinę przyjazdu
	Wtedy powinienem uzyskać następujący szacowany czas przyjazdu: |<estimated time>|
	
	Przykłady:
	| start		| stop		| time | line		| estimated time|
