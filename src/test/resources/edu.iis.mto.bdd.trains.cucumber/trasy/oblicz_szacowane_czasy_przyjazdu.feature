...
Szablon scenariusza: Szacowanie czasu przyjazdu
	...
	I nasęptny pociąg odjeżdża o <startTime> na linii <line>
	Gdy zapytam o godzinę przyjazdu
	Wtedy powinienem uzyskać następujący szacowany czas przyjazdu: <stopTime>

	Przykłady:
	|from	|to		| startTime	|line		| stopTime	|
