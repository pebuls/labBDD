...
Scenariusz: Znajdź szacowany czas przejazdu
	Szacowanie czasu przyjazdu
	Zakładając chcę się dostać z "Parramatta" do "TownHall"
	I natępny pociąg odjeżdża o 8:02 na linii "Western"
	Gdy zapytam o godzinę przyjazdu
	Wtedy powinienem uzyskać następujący szaczowany czas przyjazdu: 8:29
